...
edgeList <- subset(edgeList,Source=='Puerto Rico')
...
D3_network_LM <- networkD3::forceNetwork(Links = edgeList, # data frame that contains info about edges
                                         ...
                                         height = 300, # Size of the plot (vertical)
                                         width = 300,  # Size of the plot (horizontal)
...
# Plot network
D3_network_LM
networkD3::saveNetwork(D3_network_LM, "D3_Terror_PR.html", selfcontained = TRUE)
